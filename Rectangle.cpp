...
void Quadrangle::Draw(const MyMatrix4x4& viewProjectionMatrix, const MyMatrix4x4& viewportMatrix, uint32_t color) {

	MyVector3 screenPos[4];
	...
	Novice::DrawLine(int(screenPos[0].x), int(screenPos[0].y), int(screenPos[3].x), int(screenPos[3].y), color);
	Novice::DrawLine(int(screenPos[1].x), int(screenPos[1].y), int(screenPos[2].x), int(screenPos[2].y), color);
	Novice::DrawLine(int(screenPos[3].x), int(screenPos[3].y), int(screenPos[2].x), int(screenPos[2].y), color);
}