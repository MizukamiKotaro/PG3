...
MyVector3 Calc::Lerp(const MyVector3& p0, const MyVector3& p1, float t) {
	MyVector3 result = {};
...
MyVector3 Calc::Bezier(const MyVector3& p0, const MyVector3& p1, const MyVector3& p2, float t) {
	MyVector3 result = Lerp(Lerp(p0, p1, t), Lerp(p1, p2, t), t);
	return result;
}

MyVector3 Calc::Catmull_rom(const MyVector3& p0, const MyVector3& p1, const MyVector3& p2, const MyVector3& p3, float t) {
	MyVector3 result = {};
