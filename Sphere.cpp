...
void Sphere::Initialize(const MyVector3& center, const float& radius) {
	center_ = center;
	scale_ = { 1.0f,1.0f,1.0f };
	rotate_ = {};
	radius_ = radius;
...
void Sphere::Initialize(const MyVector3& center, const MyVector3& rotate, const float& radius) {
	center_ = center;
	scale_ = { 1.0f,1.0f,1.0f };
	rotate_ = rotate;
	radius_ = radius;
...
void Sphere::Initialize(const MyVector3& center, const MyVector3& scale, const MyVector3& rotate, const float& radius) {
	center_ = center;
	scale_ = scale;
	rotate_ = rotate;
	radius_ = radius;
...
void Sphere::Draw(const MyMatrix4x4& viewProjectionMatrix, const MyMatrix4x4& viewportMatrix, uint32_t color) {
	...
	MyMatrix4x4 worldMatrix = MyMatrix4x4::MakeAffinMatrix(scale_, rotate_, center_);
